...
public class SeaterBus extends Bus
{
	...
	public SeaterBus(String id, boolean ac, int available_seats, int booked, int cancelled, int fare, String name)
	{
		super(id,"seater",ac,available_seats,booked,cancelled,fare,name);
	}
	...
	public void showStatus(Customer c)
	{
		...
		for(int i=0;i<4;i++)
		{
				System.out.println("  "+(i+1)+"  "+seatings[i][0]+"  "+seatings[i][1]+"  "+seatings[i][2]+"  ");
		}
		int n;
